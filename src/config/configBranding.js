...
import facebookImage from '../assets/gymnetFacebook-1200x630.jpg';
import twitterImage from '../assets/gymnetTwitter-600x314.jpg';
...
export const marketplaceColor = '#2ebff7';
