...
const TABS_BOOKING = [DETAILS, LOCATION, PRICING, AVAILABILITY, PHOTOS, BCKGRNDCHECK];
...
const tabLabelAndSubmit = (intl, tab, isNewListingFlow, processName) => {
  ...
  if (tab === DETAILS) {
    ...
    else if (tab === BCKGRNDCHECK) {
    labelKey = 'EditListingWizard.tabLabelBackgroundCheck';
    submitButtonKey = `EditListingWizard.${processNameString}${newOrEdit}.saveBackgroundCheck`;
