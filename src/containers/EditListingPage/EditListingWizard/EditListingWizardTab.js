...
export const BCKGRNDCHECK = 'background-check';

const [backgroundCheckStatus, setBackgroundCheckStatus] = useState(null);
...
const EditListingWizardTab = props => {
  ...
  switch (tab) {
    ...
    case BCKGRNDCHECK: {
    	return (
			<EditListingBckgrndCheckPanel
			{...panelProps(BCKGRNDCHECK)}
			/>
    	)
